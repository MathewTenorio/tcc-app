...
<nav id="sidebar" class='mx-lt-5 shadow-lg' style="margin-left: -250px;">
		<div id="s-list" class="sidebar-list ">
				...
				<a href="index.php?page=card" class="nav-item nav-card"><span class='icon-field'><i class="fa fa-users mr-2" style="font-weight: 800;"></i></span> Card </a>
				<a href="index.php?page=dragndrop" class="nav-item nav-dragndrop"><span class='icon-field'><i class="fa fa-users mr-2" style="font-weight: 800;"></i></span> DragnDrop </a>
